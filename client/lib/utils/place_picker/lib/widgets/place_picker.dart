...
import '../widgets/near_by_place_item.dart';
...
class PlacePicker extends StatefulWidget {
  ...
  final Function(LocationResult?)? updateLocation;
  PlacePicker(this.apiKey,
      {this.displayLocation, this.localizationItem, this.updateLocation});
...
class PlacePickerState extends State<PlacePicker> {
  ...
  void initState() {
    super.initState();
    markers.add(Marker(
      position: widget.displayLocation ?? LatLng(48.858370, 2.294481),
          ...
          Expanded(
            child: GoogleMap(
              initialCameraPosition: CameraPosition(
                target: widget.displayLocation ?? LatLng(48.858370, 2.294481),
                zoom: 15,
              ),
            ...
            Column(
              ...
              children: <Widget>[
                SelectPlaceAction(getLocationName(), () {
                  if (widget.updateLocation != null) {
                    widget.updateLocation!(this.locationResult);
                  }
